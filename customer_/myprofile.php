...
<?php 
    ...
    {
        if ( isset($_POST["c_name"]) && isset($_POST["c_contno"]) && isset($_POST["c_add"]) && isset($_POST["c_email"]) )
        {
			$uid=$_SESSION['c_id'];
            $c_name=$_POST["c_name"];
            $c_contact=$_POST["c_contno"];
            $c_add=$_POST["c_add"];
            $c_email=$_POST["c_email"];
            // $c_pass=$_POST['c_pass'];
            
            if($c_name!='' && $c_contact!='' && $c_add!='' && $c_email!='' )
            {
                $sql7= "update customer set c_name='".$c_name."',c_contno='".$c_contact."',c_add='".$c_add."',c_email='".$c_email."' where c_id ='$uid'";
                //echo $sql
                //die;
                    ...
                    <div class="p-2">
                        <form action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="c_name" value="<?php echo $c_name;?>" class="form-control" id="c_name" required='true'>
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Your Contact No.</label>
                                <input type="contact" name="c_contno" value="<?php  echo $c_contno;?>" class="form-control" id="c_contno" required='true'>
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Your Address</label>
                                <input type="text" name="c_add" value="<?php  echo $c_add;?>" class="form-control" id="c_add" required='true'>
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Your Email</label>
                                <input type="email" name="c_email" value="<?php  echo $c_email;?>" class="form-control" id="c_email" required='true' >
                            </div>
