...
<!-- Mirrored from www.einfosoft.com/templates/admin/spice/source/layouts_form.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Aug 2022 08:35:15 GMT -->
<head>
	<meta charset="utf-8" />
								...
								<ul class="sub-menu">
									...
									<li class="nav-item">
										<a href="modal.html" class="nav-link ">
											<span class="title">Modal Dialog</span>
										</a>
									</li>
									<li class="nav-item">
								...
								<div class="card-body " id="bar-parent1">
									<form class="form-horizontal">
                                        <div class="form-group row">
											<label for="horizontalFormName"
												class="col-sm-2 control-label">Name</label>
											<div class="col-sm-10">
												<input type="name" class="form-control" id="horizontalFormName"
										...
										<div class="form-group row">
											<label for="horizontalFormPassword"
