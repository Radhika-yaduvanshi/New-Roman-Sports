                                    ...
                                    <div class="table-scrollable">
                                        <table id="example1" class="display full-width">
                                           <thead>
                                                ...
                                                <tbody>
                                                    <?php 
                                                    $sql="select * from `order` o join customer c join product p where o.c_id=c.c_id and o.p_id=r.p_id";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="order_del.php?id=<?php echo $uid;?>"><img src="delete.png" alt="logo-dark" height="35"></a>&nbsp</td>
                                                        <a href="update.php?id=<?php echo $uid;?>"><img src="update.jfif" alt="logo-dark" height="30"></a></td> 
                                                        <td><a class="parent-item"href="order_details.php?id=<?php echo $oid;?>">View details</a></td>
